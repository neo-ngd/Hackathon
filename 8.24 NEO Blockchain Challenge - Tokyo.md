...
　残高照会できた方が、その2つの残高を challenge@neo.org へ下記のフォーマットでメールしてください。<BR>
...
Query the balance of the specified address at the specified block height.<BR>
<BR>
